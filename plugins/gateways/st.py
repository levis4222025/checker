...
from Gates.st import stripe_charge1
...
'''
    ...
    ccc = None
    if len(message.text.split('st ')) > 1 and message.text.split('st ')[1].strip():
            ccc = message.text.split('st ')[1].strip()
