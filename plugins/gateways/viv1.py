...
from Gates.viv1 import Vantiv_charge1
...
'''
    ...
    ccc = None
    if len(message.text.split('vc ')) > 1 and message.text.split('vc ')[1].strip():
            ccc = message.text.split('vc ')[1].strip()
