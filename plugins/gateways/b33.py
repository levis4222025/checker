...
from Gates.b33 import B3_Auth3
...
'''
    ...
    ccc = None
    if len(message.text.split('cc ')) > 1 and message.text.split('cc ')[1].strip():
            ccc = message.text.split('cc ')[1].strip()
...
''', quote=True, disable_web_page_preview=True)
    ...
    msg = await B3_Auth3(cc,mm,yy,cvv)
