...
'''
    ...
    ccc = None
    if len(message.text.split('sh ')) > 1 and message.text.split('sh ')[1].strip():
            ccc = message.text.split('sh ')[1].strip()
...
''', quote=True, disable_web_page_preview=True)
    ...
    site = 'https://www.texasboysoutdoors.org/products/donation'
    url = f'https://ayanvbv.alwaysdata.net/ash/autosh.php?site={site}&cc={cccc}'
    try:
