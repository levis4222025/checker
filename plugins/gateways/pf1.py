...
from Gates.ttms import cc_check
...
'''
    ...
    ccc = None
    if len(message.text.split('pf ')) > 1 and message.text.split('pf ')[1].strip():
            ccc = message.text.split('pf ')[1].strip()
